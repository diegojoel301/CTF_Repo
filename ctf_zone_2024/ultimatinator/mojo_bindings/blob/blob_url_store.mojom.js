...
(function() {
  ...
  BlobURLStore_Register_Params.validate = function(messageValidator, offset) {
    ...
    // validate BlobURLStore_Register_Params.unsafeTopLevelSite
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, schemeful_site$.SchemefulSite, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  BlobURLStore_Register_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  BlobURLStore_Register_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(schemeful_site$.SchemefulSite, val.unsafeTopLevelSite);
  };
  ...
  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.unsafeTopLevelSite
  ...
  BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kBlobURLStore_ResolveAsURLLoaderFactory_Name = 2;
  var kBlobURLStore_ResolveForNavigation_Name = 3;
  ...
  BlobURLStoreProxy.prototype.register = function(blob, url, unsafeAgentClusterId, unsafeTopLevelSite) {
    var params_ = new BlobURLStore_Register_Params();
    params_.blob = blob;
    params_.url = url;
    params_.unsafeAgentClusterId = unsafeAgentClusterId;
    params_.unsafeTopLevelSite = unsafeTopLevelSite;
  ...
  BlobURLStoreStub.prototype.register = function(blob, url, unsafeAgentClusterId, unsafeTopLevelSite) {
    return this.delegate_ && this.delegate_.register && this.delegate_.register(blob, url, unsafeAgentClusterId, unsafeTopLevelSite);
  }
  ...
  BlobURLStoreStub.prototype.acceptWithResponder =
    ...
    case kBlobURLStore_Register_Name:
      ...
      this.register(params.blob, params.url, params.unsafeAgentClusterId, params.unsafeTopLevelSite).then(function(response) {
        var responseParams =
    ...
    case kBlobURLStore_ResolveAsURLLoaderFactory_Name:
      ...
      this.resolveAsURLLoaderFactory(params.url, params.factory).then(function(response) {
        ...
        responseParams.unsafeTopLevelSite = response.unsafeTopLevelSite;
        var builder = new codec.MessageV1Builder(
            kBlobURLStore_ResolveAsURLLoaderFactory_Name,
