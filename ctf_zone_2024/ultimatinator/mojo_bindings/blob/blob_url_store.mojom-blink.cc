...
void BlobURLStoreProxy::ResolveForNavigation(
    const ::blink::KURL& in_url, ::mojo::PendingReceiver<BlobURLToken> in_token, ResolveForNavigationCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void BlobURLStoreInterceptorForTesting::ResolveAsURLLoaderFactory(const ::blink::KURL& url, ::mojo::PendingReceiver<::network::mojom::blink::URLLoaderFactory> factory, ResolveAsURLLoaderFactoryCallback callback) {
