...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) BlobRegistry_GetBlobFromUUID_Params_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<BlobRegistry_GetBlobFromUUID_Params_Data>;
...
class COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) BlobRegistry_GetBlobFromUUID_ResponseParams_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<BlobRegistry_GetBlobFromUUID_ResponseParams_Data>;
...
class BlobRegistry_GetBlobFromUUID_ParamsDataView {
 public:
  BlobRegistry_GetBlobFromUUID_ParamsDataView() = default;
...
class BlobRegistry_GetBlobFromUUID_ResponseParamsDataView {
 public:
  BlobRegistry_GetBlobFromUUID_ResponseParamsDataView() = default;
